...
- **文字編輯器** 如果你還沒有這樣的程式，最好安裝一個特別用來寫程式的文字編輯器。這邊提供大家一些選項：[Atom](http://www.atom.io)、[Sublime Text 3](https://www.sublimetext.com/3)、[Textmate](http://macromates.com/download)、[Brackets](http://brackets.io/)。
